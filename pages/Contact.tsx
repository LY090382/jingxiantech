                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
                            ...
                            <div className="space-y-6">
                                ...
                                {/* 微信联系卡片 - 与Footer风格一致 */}
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl border border-green-100 flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-green-600 text-xs mt-1 leading-relaxed">获取即时技术支持与产品咨询</p>
                                    </div>
                                </div>
                            </div>
                        </div>
